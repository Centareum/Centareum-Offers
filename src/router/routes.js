...
// Views
const Dashboard = resolve => { require.ensure(['../components/centareum/DApp.vue'], ()=>{ resolve(require('../components/centareum/DApp.vue')); }); };
...
const BasicForms = resolve => { require.ensure(['../components/centareum/DApp1.vue'], ()=>{ resolve(require('../components/centareum/DApp1.vue')); }); };
...
const Tables = resolve => { require.ensure(['../components/centareum/DApp0.vue'], ()=>{ resolve(require('../components/centareum/DApp0.vue')); }); };
