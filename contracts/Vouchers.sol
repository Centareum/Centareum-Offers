...
contract Vouchers is Contactable {
    ...
    constructor() public {
        ...
        setContactInformation("Centareum is refining the future of global brick & mortar retail business.We aim to drive an impact through a unique, easy to operate and Customer-loyalty creating end-to-end proximity based mobile marketing platform enabled by Blockchain and AI");
    }
